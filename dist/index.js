...
const printContents = (changelogLocation, changesLocation) => {
    ...
    try {
        const folderFiles = (0, fs_1.readdirSync)(changelogLocation, { encoding: 'utf-8' });
    ...
    try {
        const changeFiles = (0, fs_1.readdirSync)(changesLocation, { encoding: 'utf-8' });
    ...
    const changelogPath = (0, path_1.join)(changelogLocation, changelogName);
    // Print the changelog.md content
    try {
        const changelogFile = (0, fs_1.readFileSync)(changelogPath, { encoding: 'utf-8' });
...
const actionHelpers_1 = __nccwpck_require__(286);
/**
 * Action entry point.
 */
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Action inputs
            const semanticVersion = (0, core_1.getInput)('semantic-version', { required: true });
            const changelogLocation = (0, core_1.getInput)('changelog-location');
            const differentLocation = (0, core_1.getInput)('changes-in-different-location') === 'true';
            let changesLocation;
            if (!differentLocation) {
                changesLocation = (0, path_1.join)(changelogLocation, 'changes');
            }
            else {
                changesLocation = (0, core_1.getInput)('changes-location', { required: true });
            }
            ...
            (0, actionHelpers_1.printContents)(changelogLocation, changesLocation);
            // Run the executable
            const executablePath = (0, path_1.join)(__dirname, 'clm.exe');
            try {
                const executableOutput = (0, child_process_1.execFileSync)(executablePath, [semanticVersion, changelogLocation, changesLocation], { encoding: 'utf-8' });
